...
import 'package:publish/ResultPage.dart';
import 'package:video_player/video_player.dart';
import 'package:flutter/cupertino.dart';
import 'video_items.dart';
import 'package:firebase_storage/firebase_storage.dart';

final storage = FirebaseStorage.instanceFor(bucket: "gs://danceproject-43407.appspot.com");
final storageRef = FirebaseStorage.instance.ref("gs://danceproject-43407.appspot.com");
final danceRef =  storageRef.child("dance.mpeg");
      ...
      body: _controller1 != null && _controller2 != null
        ...
        children: [
          ...
          Container(
            height: 50,
            child: (
                  Text('Please wait as we analyze your dance')
                ),
          )
        ],
      )
